...
import alignmentContent from '@/content/alignmentCalculator.md';
...
<template>
  <div class="tool-view">
    ...
    <InfoPanel :content-html="alignmentContent" />
...
.under-construction-panel { grid-column: 1 / -1; display: flex; flex-direction: column; align-items: center; text-align: center; padding: 3rem 2rem; background-color: var(--warning-color); border: 1px solid #ffeeba; border-radius: 8px; color: var(--warning-text); margin-top: 2rem; }
