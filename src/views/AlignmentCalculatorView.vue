    ...
    <HelpModal :isOpen="showHelp" @close="showHelp = false">
      ...
      <template #default>
        <div class="help-content">
          ...
          <p>
            A vinyl record is cut by a lathe where the cutting stylus moves in a straight line across the record. A standard pivoted tonearm, however, moves in an arc. This geometric difference creates a <strong>tracking error</strong> – a small angular deviation between the cartridge's cantilever and the true tangent of the record groove. This error introduces distortion. The goal of proper alignment is to minimize this distortion across the entire playable surface of the record.
          </p>
          ...
          <ul>
            ...
            <li><strong>Null Points:</strong> The two specific points on the record's surface where the cantilever is perfectly tangent to the groove, resulting in <strong>zero tracking error</strong>. All alignment geometries are defined by the placement of these two points.</li>
          </ul>
          ...
          <ol>
            ...
            <li>
              <strong>CRITICAL:</strong> In the print dialog, ensure scaling is set to <strong>100%</strong> or <strong>"Actual Size"</strong>. Do NOT use "Fit to Page" or any other scaling, as this will make the protractor inaccurate.
            </li>
            <li>Set the page orientation to <strong>Landscape</strong>.</li>
            <li>After printing, use a precise ruler to measure the <strong>100mm Scale Reference</strong> line on the printout. If it does not measure exactly 100mm, your printer settings are incorrect.</li>
...
.help-content h4 { margin-top: 1.5rem; margin-bottom: 0.5rem; border-bottom: 1px solid var(--border-color); padding-bottom: 0.25rem; }
