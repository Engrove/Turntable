...
<InfoPanel :content-html="alignmentContent" @open-technical-help="showHelp = true"></InfoPanel>
...
<TrackingErrorChart v-if="!store.calculatedValues.error" :chartData="store.trackingErrorChartData" :nullPoints="store.calculatedValues.nulls" :trackingMethod="store.calculatedValues.trackingMethod" class="tracking-chart" />
<AlignmentGeometry v-if="isPivotingArm && !store.calculatedValues.error" :pivotToSpindle="store.userInput.pivotToSpindle" :effectiveLength="store.calculatedValues.effectiveLength" :overhang="store.calculatedValues.overhang" :offsetAngle="store.calculatedValues.offsetAngle" :nulls="store.calculatedValues.nulls" />
<AlignmentProtractor v-if="isPivotingArm && !store.calculatedValues.error" :pivotToSpindle="store.userInput.pivotToSpindle" :effectiveLength="store.calculatedValues.effectiveLength" :nulls="store.calculatedValues.nulls" :alignmentType="store.userInput.alignmentType" />
</div>
</div>
