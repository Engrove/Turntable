...
/* NY GRID FIX: Använd minmax(0, 1fr) för att tillåta kolumnen att krympa och möjliggöra scroll i tabellen */
...
@media (max-width: 900px) { 
  .explorer-layout { grid-template-columns: 1fr; } /* Återgå till 1fr på mindre skärmar */
