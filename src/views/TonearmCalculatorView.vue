...
import HelpModal from '@/components/HelpModal.vue' // <-- Importera den nya komponenten

// En reaktiv variabel för att styra om modalen ska visas
...
<template>
  <div class="tool-view">
    ...
    <!-- Här ligger vår nya modalkomponent. Den är dold tills showHelp blir true. -->
    <HelpModal :isOpen="showHelp" @close="showHelp = false">
      <template #header>
        <h2>Methodology & User Guide</h2>
      </template>
      
      <!-- Här är allt innehåll som kommer att visas i modalen -->
      <template #default>
