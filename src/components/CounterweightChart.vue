...
const updateChart = () => {
    ...
    // Assign the generated curve data to the FIRST dataset (index 0)
    chartInstance.data.datasets[0].data = generateData();

    // Get the current value for the point and assign it to the SECOND dataset (index 1)
...
// This function is also correct, with linear scales defined.
onMounted(() => {
