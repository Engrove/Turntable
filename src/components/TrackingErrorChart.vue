...
const activeColor = '#c0392b'; // Alltid röd för aktiv
...
const outerPoint = activeDataset.data.reduce((prev, curr) =>
Math.abs(curr.x - props.nullPoints.outer) < Math.abs(prev.x - props.nullPoints.outer) ? curr : prev
);
