...
<template>
  <div class="results-panel panel">
    ...
    <!-- m1 visas endast i detailed mode då den är irrelevant i direct -->
    ...
    <!-- Justerad visning för L4_adj_cw -->
    <div v-if="store.params.calculationMode === 'detailed'" class="result-item">
    ...
    <!-- Diagnosis visas endast om armen är balanserad eller i direct mode -->
    <div v-if="!store.calculatedResults.isUnbalanced || store.params.calculationMode === 'direct'" class="diagnosis" :class="store.diagnosis.status">
